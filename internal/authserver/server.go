...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Decorative gradient pills - like on brandfetch.com */
        .pill {
            position: absolute;
            border-radius: 100px;
            opacity: 0.7;
        ...
        .pill-2 {
            ...
            animation: float-pill 8s ease-in-out infinite reverse;
        }
        .pill-3 {
            width: 120px;
            height: 40px;
        ...
        <div class="card">
            ...
            <form method="POST" action="/auth" id="authForm">
                <div class="form-group">
                    <label for="client_id">API Key</label>
                    <input
                        type="password"
                        id="client_id"
                        name="client_id"
                        ...
                        required
                    >
                    <p class="hint">Used for search and logo lookups</p>
                </div>

                <div class="form-group">
                    <label for="api_key">Brand API Key <span class="optional">(optional)</span></label>
                    <input
                        type="password"
                        id="api_key"
                        name="api_key"
                        placeholder="Leave empty to use same key"
                        autocomplete="off"
                    >
                    <p class="hint">For full brand data (colors, fonts, etc.)</p>
                </div>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .success-icon {
            ...
            background: linear-gradient(135deg, var(--green), #5BD85B);
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
            animation: icon-pop 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s both;
            box-shadow: 0 8px 24px rgba(118, 204, 75, 0.25);
        }
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <p class="message">
                Your API credentials have been securely stored. You're all set to start fetching Brandfetch data.
            </p>
